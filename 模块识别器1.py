...
import 自定义函数解释器
import ast
def job1(exe,d1,d2,CodeData,FileType=False):
    RunTime = 0
    if FileType:
        RunTime = time.time()
    nun1 = None
...
未找到指定文件''')
                    ...
                    nun3 = 模块识别器2.job2(n25[1],d1,d2,CodeData)
                    d1 = nun3[0]
                    d2 = nun3[1]
                    if nun3[2] == '1':
                        break
...
导入次数必须是整数''')
                                ...
                                for _ in range(int(d1[l30[2]])):
                                    l31 = 模块识别器2.job2(l30[1],d1,d2,CodeData)
                                    d1 = l31[0]
                                    d2 = l31[1]
                                    if l31[2] == '1':
                                        Break = True
...
导入次数必须是整数''')
                        ...
                        for _ in range(int(l30[2])):
                            l32 = 模块识别器2.job2(l30[1],d1,d2,CodeData)
                            d1 = l32[0]
                            d2 = l32[1]
                            if l32[2] == '1':
                                Break = True
